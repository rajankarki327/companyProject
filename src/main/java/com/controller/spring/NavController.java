...
import com.service.spring.NavService;
	...
	public class NavController {
		...
		@RequestMapping(value = "/add-nav", method = RequestMethod.POST)
...
//			String s = S.getEmail();
		...
		@RequestMapping(value = "/nav-table", method = RequestMethod.GET)
		...
		@RequestMapping(value = "/delete-nav/{id}", method = RequestMethod.GET)
		...
		@RequestMapping(value = "/edit-nav/{id}", method = RequestMethod.GET)
		...
		@RequestMapping(value = "/edit-nav/update/{id}", method = RequestMethod.POST)
